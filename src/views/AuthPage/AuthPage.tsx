...
export function AuthPage({ user, onAuthenticated, onLogout, onNavigate, initialMode = 'login' }: AuthPageProps) {
  const [mode, setMode] = useState<AuthMode>(initialMode);
  const { values, errors, isSubmitting, submitError, updateField, handleInputChange, handleSubmit } = useAuthForm(mode, onAuthenticated);
        ...
        <div className={styles.layout}>
          <aside className={styles.intro}>
            ...
            <div className={styles.benefits}>
              ...
              <span>
                <CheckIcon /> Histórico de reservas
              </span>
            </div>
            ...
            <div className={styles.securityNote}>
              <ShieldIcon />
              <span>
                <strong>Acesso seguro</strong> A sua conta permite gerir as reservas e os dados pessoais.
              </span>
            </div>
          </aside>
          ...
          <div className={styles.panel}>
            <div className={styles.tabs} role="tablist" aria-label="Acesso à conta">
              <button
                ...
                onClick={() => { setMode('login'); onNavigate('/login'); }}
              >
                Entrar
              </button>
              <button
                ...
                onClick={() => { setMode('register'); onNavigate('/register'); }}
              >
                Criar conta
              </button>
            </div>
            ...
            <form className={styles.form} onSubmit={handleSubmit} noValidate>
              ...
              <button className={styles.submitButton} type="submit" disabled={isSubmitting}>
                {isSubmitting ? 'A processar…' : mode === 'login' ? 'Entrar na conta' : 'Criar a minha conta'}
              </button>
            </form>
          </div>
        </div>
