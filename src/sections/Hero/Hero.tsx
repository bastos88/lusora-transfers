...
export function Hero({ onBookingSubmit, onNavigate, user }: HeroProps) {
  return (
    <section
    ...
    >
      <Header onNavigate={onNavigate} accountLabel={user ? `Olá, ${user.name.split(' ')[0]}` : 'Entrar'} />
      <div className={styles.content}>
        <div className={styles.copy}>
          <p className={styles.eyebrow}>Transfer privado · Porto</p>
          <h1 id="hero-title">Reserve já a sua viagem!</h1>
          <p className={styles.description}>
            Transfers confortáveis de e para o Aeroporto do Porto, com recolha à hora combinada e serviço porta a porta.
          </p>
          <a className={styles.cta} href="#reserva">Fazer uma reserva</a>
        </div>
