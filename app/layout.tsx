...
export const metadata: Metadata = {
  ...
  description:
    'Transfers privados de e para o Aeroporto do Porto. Escolha o serviço e a viatura e organize a sua viagem.',
};
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <html lang="pt-PT">
      <body>
        <AppProvider catalog={catalog}>{children}</AppProvider>
      </body>
    </html>
  );
}
